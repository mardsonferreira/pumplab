...
export function Plan({ plans, onSelectPlan }: PlanProps) {
        ...
        <div className="mb-12 grid grid-cols-1 gap-8 md:grid-cols-3">
            {plans.map((plan, index) => (
                <div
                    ...
                    className={`flex flex-col justify-between relative rounded-lg border p-8 transition-all duration-200 ${
                        index === 1
                    ...
                    <div>
                        ...
                        <div className="flex items-center mb-6">
                            ...
                            {plan.billing_cycle === "monthly" && <p className="ml-2 text-sm text-neutral-400">por mês</p>}
                        </div>
